  ...
  return (
    <div className="fixed inset-0 z-20 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-lg dark:bg-gray-900">
        ...
        <h2 className="mb-4 text-lg font-semibold text-gray-800 dark:text-gray-100">Guardar dirección favorita</h2>

        <div className="mb-4">
          <label htmlFor="favorite-address" className="mb-1 block text-xs font-semibold text-gray-500 dark:text-gray-400">
            DIRECCIÓN
          </label>
          <div className="rounded-lg border border-gray-300 p-1 dark:border-gray-600">
        ...
        <p className="mb-2 text-xs font-semibold text-gray-500 dark:text-gray-400">ETIQUETA</p>
        ...
        {label === 'other' && (
          <div className="mb-5">
            <label htmlFor="favorite-custom-label" className="mb-1 block text-xs font-semibold text-gray-500 dark:text-gray-400">
              NOMBRE
            </label>
            <input
