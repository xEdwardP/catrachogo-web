...
export function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-cream p-4">
      <div
        aria-hidden="true"
      ...
      <div className="relative w-full max-w-md rounded-3xl bg-white p-8 shadow-xl shadow-brand/5 ring-1 ring-black/5">
